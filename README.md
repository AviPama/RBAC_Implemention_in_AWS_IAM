...
**How It Works**
Provision IAM Users & Groups – Define user roles and associate them with appropriate groups.
Assign Policies – Apply least-privilege policies to restrict access to only necessary resources.
Test Access – Attempt unauthorized actions to validate security measures.
